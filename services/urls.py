...
urlpatterns = [
    path(
        "diagnosis-result/<int:appointment_id>/",
        views.diagnosis_result_detail,
        name="diagnosis_result_detail",
    ),
    path("categories/", views.category_list, name="category_list"),
    path("services/", views.services, name="services"),
    path(
        "category/<int:category_id>/", views.category_services, name="category_services"
    ),
    ...
    path(
        "appointments/available_slots/<int:doctor_id>/",
        views.get_available_slots,
        name="get_available_slots",
    ),
    path("dashboard/", views.doctor_dashboard, name="dashboard"),
    path(
        "result/<int:appointment_id>/create/",
        views.create_diagnosis_result,
        name="create_result",
    ),
    path(
        "result/<int:appointment_id>/view/",
        views.view_diagnosis_result,
        name="view_result",
    ),
    path(
        "result/<int:appointment_id>/edit/",
        views.edit_diagnosis_result,
        name="edit_result",
    ),
    path(
        "result/<int:appointment_id>/delete/",
        views.delete_diagnosis_result,
        name="delete_result",
    ),
]
